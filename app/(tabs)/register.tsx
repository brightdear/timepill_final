...
import { getMedications, getMedicationByName, getMedicationById, insertMedication, deleteMedication } from '@/domain/medication/repository'
import { insertTimeslot, getTimeslotById, updateTimeslot, deleteTimeslot } from '@/domain/timeslot/repository'
import { insertDoseRecord, deleteDoseRecord, getTodayDoseRecordForSlot, updateDoseRecordScheduledTimeForSlot } from '@/domain/doseRecord/repository'
import { upsertStreak } from '@/domain/streak/repository'
import { scheduleAlarmsForSlot } from '@/domain/alarm/alarmScheduler'
import { scheduleForceAlarmsForSlot } from '@/domain/alarm/forceAlarmScheduler'
import { captureReferenceImage, type ScanDebugInfo } from '@/domain/scan/runScanInference'
import { getReferenceImages, insertReferenceImage, deleteReferenceImage } from '@/domain/referenceImage/repository'

import { isTodayDue } from '@/utils/cycleUtils'
import { getLocalDateKey, toLocalISOString } from '@/utils/dateUtils'
import { deleteAsync } from 'expo-file-system/legacy'
import { setRegisterDirty, consumeRegisterReset } from '@/utils/registerGuard'
